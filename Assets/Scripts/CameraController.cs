...
public class CameraController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (ball.transform.position.x > -5f && ball.transform.position.z < 5f)
        {
            ...
            transform.rotation = Quaternion.Lerp(transform.rotation, pos1.rotation, cameraSpeed * Time.deltaTime);
        }
        //Room 2
        if (ball.transform.position.x < -5f && ball.transform.position.z < 5f)
        {
            ...
            transform.rotation = Quaternion.Lerp(transform.rotation, pos2.rotation, cameraSpeed * Time.deltaTime);
        }
        //Room 3
        if (ball.transform.position.x < -5f && ball.transform.position.z > 5f)
        {
            ...
            transform.rotation = Quaternion.Lerp(transform.rotation,pos3.rotation,cameraSpeed * Time.deltaTime);
        }
    }
}
